...
# 레벨별 예상 질문 리스트
아래 레벨은 총 5개로 구성되어있으며, 레벨은 임의로 개인적인 기준으로 나누었습니다.
...
3. 뷰를 구현할때 Storyboard와 Code로 구현하는 각각의 장단점은 무엇인가요?
    - 선호하는 방식이 있다면 무엇이고 왜 더 선호하나요?

4. Auto Layout을 사용하는 이유와 장점은 무엇인가요?
...
15. iOS 앱에서 코어 데이터(Core Data)를 사용하는 이유는 무엇인가요?
...
16. Swift의 high-order functions에 대해 설명해주세요.
    - map()과 compactMap()의 차이점은 무엇인가요?
    - filter()와 reduce()는 어떤 경우에 사용하나요?
    - flatMap()을 사용하는 경우를 예시로 들어주세요.

17. Xcode에서 유용한 단축키와 생산성을 높이는 팁에 대해 설명해주세요.

18. iOS 개발을 위한 라이브러리 관리 도구(CocoaPods, Carthage, Swift Package Manager)의 차이점과 사용법을 설명해주세요.
    - 각 도구의 장단점은 무엇인가요?

19. iOS 앱에서 URL Scheme을 사용하여 다른 앱과 통신하는 방법과 주의 사항을 설명해주세요.

20. Xcode의 인스트루먼트(Instruments)를 활용하여 앱의 성능을 분석하고 최적화하는 방법은 무엇인가요?
...
21. Swift에서 Any와 AnyObject의 차이점은 무엇인가요?

22. iOS 앱에서 NotificationCenter를 사용하는 목적과 사용 방법을 설명해주세요.
...
4. 싱글톤 패턴(Singleton Pattern)이란 무엇이며, 어떤 경우에 사용하나요?
   - 싱글톤 패턴의 장단점은 무엇인가요?
...
2. iOS 앱에서 Core Data를 사용한 데이터 마이그레이션(Migration)에 대해 설명해주세요.
...
9. iOS 앱에서 Siri Shortcuts을 구현하는 방법은 무엇인가요?
...
10. Swift의 unsafe 포인터(Unsafe Pointer)에 대해 설명해주세요.
...
12. Swift의 reflection에 대해 설명해주세요.
...
13. iOS 앱에서 Keychain을 사용하여 민감한 데이터를 안전하게 저장하는 방법은 무엇인가요?
...
14. Swift의 async/await를 사용한 비동기 프로그래밍에 대해 설명해주세요.
...
22. iOS 앱에서 Objective-C 브리징(Bridging)을 하는 방법과 주의 사항을 설명해주세요.
